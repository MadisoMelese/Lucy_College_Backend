...
async function main() {
  ...
  const techFaculty = await prisma.faculty.upsert({
    ...
    create: {
      ...
      facultyCode: "TECH",
      description:
        "Dedicated to advancing technology and engineering sciences.",
  ...
  await prisma.course.upsert({
    ...
    create: {
      ...
      tuitionFee: 1500.0, // Pass as number to match Decimal
      departmentCode: csDept.departmentCode, // Linked by ID
    },
  });
  ...
  await prisma.course.upsert({
    ...
    create: {
      ...
      tuitionFee: 1500.0, // Pass as number to match Decimal
      departmentCode: eeDept.departmentCode, 
    },
  });
  ...
  await prisma.lecturer.upsert({
    ...
    create: {
      ...
      lastName: "Smith",
      title: "Ms.",
      departmentCode: csDept.departmentCode,
  ...
  if (!existingAbout) {
    await prisma.about.create({
      data: {
        ...
        content:
          "Lucy College is committed to providing high quality education and a supportive learning environment.",
  ...
  if (galleryCount === 0) {
    await prisma.galleryImage.createMany({
      data: [
        {
          title: "Campus Life",
          caption: "Students on campus",
          imageUrl: "http://localhost:3000/uploads/gallery/gallery1.jpg",
          category: "campus",
        },
        {
          title: "Graduation",
          caption: "Commencement ceremony",
          imageUrl: "http://localhost:3000/uploads/gallery/gallery2.jpg",
          category: "events",
        },
      ],
    });
  ...
  if (!existingHome) {
    await prisma.homepage.create({
      data: {
        ...
        heroCtaUrl: "/apply",
        introText:
          "Lucy College offers a wide range of programs designed to prepare students for success.",
      },
    });
      ...
      data: [
        {
          ...
          role: "Principal",
          bio: "Experienced academic leader.",
          imageUrl: "http://localhost:3000/uploads/management/jane.jpg",
          email: "jane.smith@lucy.edu",
        },
        {
          fullName: "Mr. John Doe",
          role: "Registrar",
          bio: "Oversees student services.",
          imageUrl: "http://localhost:3000/uploads/management/john.jpg",
          email: "john.doe@lucy.edu",
        },
      ],
    });
  ...
  if (inquiryCount === 0) {
    await prisma.inquiry.create({
      data: {
        ...
        message:
          "I would like more information about the Computer Science program.",
      },
    });
