...
export const createProgram = async (payload) => {
    ...
    if (!dept) throw new Error(`Department Code '${payload.departmentCode}' does not exist.`);
...
export const updateProgram = async (id, updateData) => {
    ...
    if (data.departmentCode) data.departmentCode = data.departmentCode.toUpperCase();
